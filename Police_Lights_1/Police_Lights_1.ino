/*
Police lighs using FastLED
*/ 


#defime FastLED_INTERNAL
#include "FastLED.h" 
...
void setup() {
	...
	FastLED.addLeds<WS2812, 6, GRB>leds1, NUM_LEDS);        //strip2 or top row
	FastLED.addLeds<WS2812, 7, GRB>leds3, NUMLEDS3);	//strip3 or computer lights
	FastLED.setBrightness(255);							//full brightness

}

void loop() {
		for(int x = 0; x < e; x++_ {	//repeat the flash 3 times
				group1 = color1;
				group11 = color1; 
				group21 = color1;
				group3 = color1;
